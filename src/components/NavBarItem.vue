...
const itemLabel = computed(() =>
  props.item.isCurrentUser ? authStore.user?.username || 'No disponible' : props.item.label,
)

const isDropdownActive = ref(false)

const menuClick = (event) => {
  console.log('NavBarItem menuClick:', props.item)
...
const menuClickDropdown = (event, item) => {
  console.log('NavBarItem menuClickDropdown:', item)
