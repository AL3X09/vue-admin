...
export const gradientBgGreenTeal = `${gradientBgBase} from-emerald-500 via-teal-500 to-cyan-500`
export const gradientBgGreenSoft = `${gradientBgBase} from-green-400 via-emerald-400 to-teal-500`
